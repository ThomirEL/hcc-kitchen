...
public class RenderManager : MonoBehaviour
{
    ...
    public void RefreshAndRenderAll()
    {
        ...
        {
            Debug.Log("[RenderManager] Calling CanManager.RenderBaseCans()");
        ...
        {
            Debug.Log("[RenderManager] Calling DryGoodsManager.RenderBaseCans()");
        ...
        {
            Debug.Log("[RenderManager] Calling SpiceManager.RenderBaseCans()");
